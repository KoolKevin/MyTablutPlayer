...
public abstract class State {
	...
	public int[] getCoordinates(String box) {
		int[] coordinates = new int[2];
		
		// primo carattere è la colonna
		// secondo carattere è la riga
		char rowChar = box.charAt(1);
		coordinates[0] = Character.getNumericValue(rowChar) - 1;
		char colChar = box.charAt(0);
	    coordinates[1] = colChar - 'a'; // 'a' diventa 0, 'b' 1, ecc.
